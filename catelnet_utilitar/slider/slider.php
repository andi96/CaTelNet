<!-- Start Slider ////////////////////////////////////// -->
    ...
    <script type="text/javascript" src="<?php echo $full_path_utilitar_href;?>slider/jssor.slider.min.js"></script>
    ...
    <div style="position:relative;top:0;left:0;width:100%;overflow:hidden;background:#80bfff;padding-bottom:8px;padding-top:8px;border-bottom: 2px solid #0000cc;">
        ...
        <div id="slider1_container" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 980px; height: 380px;">
            ...
            <div data-u="loading" class="jssorl-009-spin" style="position:absolute;top:0px;left:0px;width:100%;height:100%;text-align:center;background-color:rgba(0,0,0,0.7);">
                <img style="margin-top:-19px;position:relative;top:50%;width:38px;height:38px;" src="<?php echo $full_path_utilitar_href;?>slider/svg/loading/static-svg/spin.svg" />
            </div>

            <!-- Slides Container -->
            <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 980px;  height: 380px; overflow: hidden;">
                <div>
					<a href="<?php echo $full_path_href;?>Baza_date_Cablu.php">
						<img data-u="image" src="<?php echo $full_path_utilitar_href;?>poze/cablu.jpg" />
					</a>
                </div>
                <div> 
					<a href="<?php echo $full_path_href;?>Baza_date_Telefon.php">
						<img data-u="image" src="<?php echo $full_path_utilitar_href;?>poze/telefon.jpg" />
					</a>
                </div>
                <div>
					<a href="<?php echo $full_path_href;?>Baza_date_Internet.php">
						<img data-u="image" src="<?php echo $full_path_utilitar_href;?>poze/internet.jpg" />
					</a>
                </div>
            </div>
