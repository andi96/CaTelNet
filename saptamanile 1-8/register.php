	...
	if($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		if(empty(trim($_POST['password']))) {
			...
			if(strlen(trim($_POST['password'])) < 7) {
				$password_err = 'Parola trebuie sa contina minim 7 caractere .';  //"Password must have atleast 6 characters.";
			} else {		
...
<div id="div_register">
	...
	<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
		...
		<p>
			...
			<input type="password" id="xc" name="confirm_password"> <br>
        ...
        <p> Aveti deja un account ? <a href="account/login.php"> Login </a></p>
	</form> 
</div>
